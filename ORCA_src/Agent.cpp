...
namespace RVO {
	...
	void Agent::computeNewVelocity()
	{
		...
		for (size_t i = 0; i < agentNeighbors_.size(); ++i) {
			...
			const Vector2 relativePosition = other->position_ - position_; //pb-pa
			const Vector2 relativeVelocity = velocity_ - other->velocity_; //va-vb
